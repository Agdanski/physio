...
export const programs: Program[] = [
    ...
    phases: [
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            name: "Torso Extensions (Table)",
            why: "Strengthens the spinal extensors in a controlled, supported position.",
            instructions: ["Lean over a table with your pelvis on the edge.", "Hold the table for support.", "Lower your torso down about six inches.", "Lift back up to table height.", "Move slowly and controlled."],
            dose: "5 reps × 5–10 second holds, daily",
            commonMistakes: ["Moving too fast", "Extending too far back"],
            easierVersion: "Smaller range of motion.",
            harderVersion: "Progress to prone version.",
            equipmentNeeded: "Sturdy table",
            imageKey: "torso-ext-table",
          },
          {
            name: "Superman / Prone Back Extension Hold (Optional Progression)",
            why: "Can build trunk extensor endurance in users who tolerate prone extension well. This is an optional later-phase progression — not a core first-line exercise.",
            instructions: [
              "Lie on your stomach with arms by your sides or overhead if tolerated.",
              "Gently lift the chest and/or legs a small amount off the floor.",
              "Keep the neck neutral.",
              "Hold briefly, then lower slowly.",
            ],
            dose: "2–3 sets of 5–8 reps or short 5–10 second holds, every other day",
            keyCues: [
              "Lift only a small amount.",
              "Do not crank into end-range extension.",
              "Stop before form breaks down.",
            ],
            commonMistakes: ["Lifting too high", "Hyperextending the neck", "Holding the breath"],
            easierVersion: "Lift only the chest with arms by your sides.",
            harderVersion: "Arms overhead with longer holds.",
            equipmentNeeded: "None",
            stopIf: "It causes sharp back pain, reproduces or worsens leg symptoms, or symptoms are clearly worse the next day.",
            imageKey: "superman-prone-extension",
          },
        ],
      },
    ],
  ...
  // ───────────────────────────────────────────────────────────
  // 13. HIP BURSITIS / GREATER TROCHANTERIC PAIN SYNDROME (GTPS)
  // ───────────────────────────────────────────────────────────
  {
    id: "gtps",
    condition: "Hip Bursitis / Greater Trochanteric Pain Syndrome (GTPS)",
    goal: "Reduce pain on the outside of the hip, improve tolerance for walking, stairs, standing, and lying down, and gradually rebuild hip strength and load tolerance.",
    description: "This program is for pain on the outer side of the hip, often historically called \"hip bursitis.\" Many cases are now understood to involve the gluteal tendons and surrounding lateral hip structures rather than an isolated bursa problem. Conservative care commonly includes activity modification, avoiding compressive positions, and progressive hip strengthening.",
    bodyRegion: "hip-groin",
    symptoms: [
      ...
      "Pain after sitting with crossed legs",
      "Tenderness over the outer hip",
      "Pain that may spread down the outside of the thigh",
    ],
    bestFor: "People with outer hip or lateral thigh pain aggravated by lying on the side, stairs, prolonged standing, or standing on one leg.",
    notFor: [
      "Inability to bear weight after trauma",
      "Sudden severe hip pain after a fall",
      "Fever, redness, or hot swollen joint",
      "Progressive numbness or weakness in the leg",
      "Major groin pain suggesting a different hip joint source",
      "Severe night pain that is rapidly worsening or unexplained",
    ],
    selfManagementAdvice: [
      "Avoid crossing your legs.",
      "Avoid \"hip hanging\" or standing with your pelvis pushed out to one side.",
      "Avoid lying directly on the painful side.",
      "If you lie on the non-painful side, place one or two pillows between the knees so the top leg is supported and the painful hip is not pulled downward.",
      "Reduce sudden spikes in walking, hill climbing, stair volume, or side-to-side exercise.",
      "Build strength gradually. Some discomfort is acceptable, but symptoms should generally settle back near baseline by the next day.",
    ],
    urgentSigns: [
      "Inability to bear weight after trauma",
      "Sudden severe hip pain after a fall",
    ...
    phases: [
      {
        name: "Phase 1: Settle Symptoms",
        description: "Focus on reducing irritation through activity modification and gentle isometric loading. Tip: Avoid crossing your legs, hanging on one hip, and lying directly on the painful side during flare-ups.",
        exercises: [
          {
            name: "Isometric Wall Press for Hip Abductors",
            why: "A useful starting exercise that loads the outer hip muscles with relatively low irritation.",
            instructions: [
              "Stand sideways next to a wall with the affected leg farthest from the wall.",
              "Bend the knee of the leg closest to the wall and press that bent leg gently into the wall.",
              "Keep your pelvis level and your trunk upright.",
              "You should feel the outer hip of the stance leg working.",
              "Hold, then relax.",
            ],
            dose: "4–5 holds of 20–30 seconds, once daily",
            keyCues: [
              "Stay tall.",
              "Keep the pelvis level.",
              "Use a moderate effort, not a maximal push.",
            ],
            commonMistakes: [
              "Leaning into the wall instead of pressing sideways.",
              "Not engaging the outer hip of the standing leg.",
            ],
            easierVersion: "Use a lighter press into the wall. Shorten the hold.",
            harderVersion: "Increase hold time gradually toward 30–45 seconds.",
            stopIf: "Pain becomes sharp, pain rapidly escalates during the hold, or symptoms are clearly worse the next day.",
            equipmentNeeded: "Wall",
            imageKey: "isometric-hip-wall",
          },
          {
            name: "Bridge",
            why: "Builds gluteal and posterior-chain strength without large side-to-side hip compression.",
            instructions: [
              "Lie on your back with knees bent and feet flat.",
              "Tighten the glutes gently.",
              "Lift the hips until shoulders, hips, and knees are roughly in line.",
              "Hold briefly, then lower slowly.",
            ],
            dose: "2–3 sets of 8–12 reps, every other day",
            keyCues: [
              "Lift with the hips, not by arching the low back.",
            ...
            easierVersion: "Smaller lift. Shorter hold.",
            harderVersion: "Add a longer hold at the top. Add a loop band around the knees if tolerated.",
            stopIf: "Outer hip pain sharply worsens or the movement causes major low back compensation.",
            imageKey: "bridge",
          },
          {
            name: "Side-Lying Hip Abduction",
            why: "Strengthens the gluteus medius and improves pelvic control.",
            instructions: [
              "Lie on your side with the painful side up.",
              "Bend the bottom knee for balance.",
              "Keep the top leg straight and slightly behind the trunk.",
              "Lift the top leg a short distance upward.",
              "Lower slowly.",
            ],
            dose: "2–3 sets of 8–12 reps, every other day",
            keyCues: [
              "Keep pelvis stacked.",
              "Toes face forward or slightly down.",
              "Stop before the trunk rolls backward.",
            ],
            commonMistakes: [
              "Rolling the pelvis backward.",
              "Rotating the toes upward.",
              "Lifting too high.",
            ],
            easierVersion: "Smaller lift. Fewer reps.",
            harderVersion: "Add a brief hold at the top. Add light ankle weight later if well tolerated.",
            stopIf: "It reproduces a major flare or pain is much worse the next day.",
            imageKey: "hip-abduction",
          },
        ],
      },
      {
        name: "Phase 2: Strength / Capacity",
        description: "Progress when Phase 1 exercises are comfortable and compression is being managed.",
        exercises: [
          {
            name: "Bridge with Band Around Knees",
            why: "Improves glute activation while avoiding prolonged hip-adduction compression.",
            instructions: [
              "Lie on your back with knees bent.",
              "Place a loop band around the knees.",
              "Gently press the knees outward against the band.",
              "Lift into a bridge.",
              "Lower slowly.",
            ],
            dose: "2–3 sets of 8–12 reps, every other day",
            keyCues: [
              "Press out gently, not maximally.",
            ...
            easierVersion: "Use a lighter band. Use a plain bridge instead.",
            harderVersion: "Longer hold at the top. More reps before increasing band resistance.",
            stopIf: "Outer hip pain clearly escalates and lingers.",
            equipmentNeeded: "Loop band",
            imageKey: "bridge-with-band",
          },
          {
            name: "Lateral Band Walk",
            why: "Progresses standing hip-abductor strength and pelvic control.",
            instructions: [
              "Place a loop band above the knees or around the ankles.",
              "Slightly bend the hips and knees.",
              "Step sideways slowly while keeping toes forward.",
              "Keep tension on the band throughout.",
            ],
            dose: "2–3 sets of 8–12 steps each direction, every other day",
            keyCues: [
              "Keep pelvis level.",
            ...
            easierVersion: "Band above knees. Smaller steps.",
            harderVersion: "Band around ankles. More steps. Slightly lower athletic stance.",
            stopIf: "It causes a major flare during or after exercise.",
            equipmentNeeded: "Loop band",
            imageKey: "lateral-band-walk",
          },
          {
            name: "Step-Up",
            why: "Builds functional hip and leg strength for stairs and daily activities.",
            instructions: [
              "Stand in front of a low step.",
              "Step up with the affected leg.",
              "Straighten fully.",
              "Step down slowly with control.",
            ],
            dose: "2–3 sets of 8–10 reps, every other day",
            keyCues: [
              "Keep the pelvis level.",
            ...
            easierVersion: "Lower step. Light hand support.",
            harderVersion: "Slightly higher step. More reps before adding height.",
            stopIf: "Pain escalates sharply or you cannot control pelvic drop or trunk sway.",
            equipmentNeeded: "Low step",
            imageKey: "step-up",
          },
        ],
      ...
      {
        name: "Phase 3: Function / Return",
        description: "Progress when Phase 2 exercises are well tolerated and daily activities are improving.",
        exercises: [
          {
            name: "Single-Leg Balance",
            why: "Improves pelvic control and tolerance for single-leg loading.",
            instructions: [
              "Stand on the affected leg.",
              "Keep the knee slightly soft.",
              "Hold your balance with the pelvis level.",
              "Light fingertip support is allowed at first.",
            ],
            dose: "3–5 holds of 20–30 seconds, daily",
            keyCues: [
              "Stay tall.",
              "Avoid letting the hip drop or trunk lean excessively.",
            ],
            commonMistakes: [
              "Locking the knee.",
              "Hanging on the hip instead of actively holding the pelvis level.",
            ],
            easierVersion: "Fingertip support. Shorter holds.",
            harderVersion: "Head turns. Less hand support. Longer holds.",
            stopIf: "It reproduces a significant flare.",
            imageKey: "single-leg-balance",
          },
          {
            name: "Sit-to-Stand",
            why: "Improves functional strength and helps transfer hip strength into daily movement.",
            instructions: [
              "Sit near the edge of a chair.",
              "Feet hip-width apart.",
              "Lean forward slightly.",
            ...
            keyCues: [
              ...
              "Move smoothly and avoid shifting heavily to one side.",
            ],
            commonMistakes: [
              "Jerking upward or using momentum.",
              "Shifting weight heavily to the non-painful side.",
            ],
            easierVersion: "Higher chair. Use hands lightly.",
            harderVersion: "Lower chair. Add reps before adding load.",
            equipmentNeeded: "Chair",
            imageKey: "sit-to-stand",
          },
        ],
    ...
    progressionRules: [
      "Progress only when symptoms remain tolerable during exercise and return near baseline by the next day.",
      "Progress one variable at a time: hold time → reps → resistance → complexity.",
      "Do not progress both band resistance and exercise volume at the same time.",
    ],
    flareUpRules: [
      "If pain is clearly worse the next day, reduce hold time, reps, band resistance, or walking/stair volume.",
      "During a flare, emphasize posture and activity modification and simpler exercises such as wall press and bridge.",
      "Avoid aggressive stretching of the outer hip during irritable phases.",
    ],
    expectedTimeline: "Some symptom improvement may occur within a few weeks. Meaningful strength and load-tolerance improvement often takes 6–12 weeks or longer. Some people improve more slowly over several months.",
    seekAssessment: [
      "No meaningful improvement after a reasonable trial",
      "Major groin pain",
      "Progressive neurologic symptoms",
      "Unexplained severe night pain",
      "Traumatic onset with difficulty weight-bearing",
    ],
    requiredEquipment: ["Wall", "Chair or step"],
    optionalEquipment: ["Loop band", "Pillow for sleeping support"],
    noEquipmentAlternative: "Use plain bridge instead of band bridge. Use wall press and sit-to-stand if no band is available.",
    programAudit: "Consistent with current understanding of greater trochanteric pain syndrome, where education, load management, and progressive strengthening of the hip muscles are commonly used first-line. Avoiding compressive postures such as crossing the legs, hanging on one hip, and lying directly on the painful side is also commonly recommended.",
  },
    ...
    phases: [
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            why: "A deeper rotational stretch that further mobilizes the lumbar spine.",
            instructions: ["Lie on your back.", "Cross one leg over the other.", "Bring both knees together to one side.", "Keep shoulders flat on the floor.", "Hold, then repeat on the other side."],
            dose: "5 reps × 5–10 second holds each side, daily",
            commonMistakes: ["Lifting shoulders off the floor", "Moving too fast"],
            easierVersion: "Standard pelvic twist without crossing legs.",
            harderVersion: "Longer holds.",
            equipmentNeeded: "None",
          ...
          {
            name: "Side Sit-Ups",
            why: "Strengthens the oblique muscles to improve lateral trunk stability.",
            instructions: ["Lie on your side with knees bent.", "Place arms across chest or behind head.", "Lift your torso sideways off the floor.", "Lower slowly and repeat.", "Perform on both sides."],
            dose: "5 reps × 5–10 second holds each side, daily",
            commonMistakes: ["Rolling forward or backward", "Using momentum"],
            easierVersion: "Smaller range of motion.",
            harderVersion: "Longer holds or more reps.",
            equipmentNeeded: "None",
          ...
          },
          {
            ...
            why: "Stretches the quadriceps and hip flexors, which can become tight and contribute to anterior pelvic tilt.",
            instructions: ["Lie on your side.", "Grasp your foot or lower leg behind you.", "Pull your heel toward your buttock.", "Keep your knees together.", "Hold, then repeat on the other side."],
            dose: "5 reps × 5–10 second holds each side, daily",
            commonMistakes: ["Arching the lower back", "Pulling too aggressively"],
            easierVersion: "Use a towel around the ankle if you can't reach.",
            harderVersion: "Longer holds.",
            equipmentNeeded: "None",
            imageKey: "quad-stretch-side-lying",
          },
          {
            name: "Back Leg Extensions (Chair)",
            why: "Strengthens the gluteals and lower back extensors in a supported position.",
            instructions: ["Stand leaning over a chair or counter for support.", "Keep your back straight.", "Lift one leg straight behind you about six inches.", "Hold, then lower slowly.", "Repeat on the other side."],
            dose: "5 reps × 5–10 second holds each side, daily",
            commonMistakes: ["Arching the lower back", "Lifting the leg too high"],
            easierVersion: "Smaller range of motion.",
            harderVersion: "Progress to prone version.",
            equipmentNeeded: "Chair or counter",
            imageKey: "back-leg-ext-chair",
          },
          {
            name: "Back Leg Extensions (Prone)",
            why: "Advanced gluteal and lower back strengthening in a prone position.",
            instructions: ["Lie face down with a large pillow under your pelvis.", "Lift one leg straight up about six inches.", "Hold, then lower slowly.", "Repeat on the other side."],
            dose: "5 reps × 5–10 second holds each side, daily",
            commonMistakes: ["Lifting too high", "Arching the lower back"],
            easierVersion: "Chair version instead.",
            harderVersion: "Longer holds or add ankle weight.",
          ...
          {
            name: "Torso Extensions (Prone)",
            why: "Advanced spinal extensor strengthening from the floor.",
            instructions: ["Lie face down with a large pillow under your pelvis.", "Arms at your sides or behind your head.", "Lift your torso up about six inches.", "Hold, then lower slowly."],
            dose: "5 reps × 5–10 second holds, daily",
            commonMistakes: ["Lifting too high", "Jerking upward"],
            easierVersion: "Table version instead.",
            harderVersion: "Longer holds.",
            equipmentNeeded: "Large pillow",
